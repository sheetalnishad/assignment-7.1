#Data Analytics Assignment 7.1 - Session 7
...
# -------------------------------------------------------------------------------------
#Q1 (a): Find out top 5 attributes having highest correlation (select only Numeric features).
...
# Q1 (b): Find out top 3 reasons for having more crime in a city.
...
# Q1 (c): Which all attributes have correlation with crime rate?
